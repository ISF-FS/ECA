...
% lon_min=39.65;
% lon_max=42.4;
Created on Sun Jan 23 09:31:48 2022
...
# create meshgrid
[X, Y ] = np.meshgrid(np.linspace(lon_min,lon_max,len(thelon)), np.linspace(lat_min,lat_max,len(thelat)))
n_cen = lon.size # number of centroids
n_ev = 100 # number of events
...
haz.event_name = ev_name('Somali%d%d')

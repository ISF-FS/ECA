# -*- coding: utf-8 -*-
"""
%%Can Tho city Vietnam Pluvial Fluvial Flood(PLFL) Hazard creation.
...
n_ev = 1 # number of events RP=100 years
...
#haz.event_name = ev_name('CanThoTIDAL%d')
haz.event_name = ['Tid_pr_spring_10m_RP100_CanTho']
